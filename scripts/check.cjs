...
for (const name of ['index.html','guide.html','settings.html']) {
...
for (const name of ['app.js','core.js','qr.js','settings-capabilities.js','settings-presets.js','settings-core.js','settings-app.js','vendor/qrcode.js']) new vm.Script(fs.readFileSync(path.join(publicDir,name),'utf8'),{filename:name});
