...
**Camera Settings QR: field tested after a firmware update.** On 2026-09-11, following a failed settings scan on original firmware, the owner reported: “I updated the firmware and everything works perfectly.” See the [hardware report](docs/HARDWARE_VALIDATION.md) for the recorded scope; the exact firmware build and presets tested were not supplied.
