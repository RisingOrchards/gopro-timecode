...
(function (root, factory) {
  ...
  const definitions = Object.freeze({
    cinema: Object.freeze({ label: 'Production / Cinema', description: 'Open Gate · 24 fps mode · 180° shutter · 10-bit GP-Log2', settings: Object.freeze({ resolution: '8k-open', frameRate: '24', whiteBalance: '5500', shutter: '180', isoMax: '400', stabilization: 'off' }) }),
    run: Object.freeze({ label: 'Run & Gun', description: '4K30 with automatic exposure, auto white balance and stabilization.', settings: Object.freeze({ resolution: '4k', frameRate: '30', whiteBalance: 'auto', shutter: 'auto', isoMax: '1600', stabilization: 'on' }) }),
    ...
    custom: Object.freeze({ label: 'Custom', description: 'Start with video mode only. Leave a field unchanged to omit it from the QR.', settings: Object.freeze({}) })
  });
  function resolve(id, model) {
    ...
    if (id === 'cinema') settings.resolution = C.models[model].cinemaResolution;
